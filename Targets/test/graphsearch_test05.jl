...
with_logger(logger) do
    ...
    # if a long term longopen exceeding regr extreme is interrupted by a short term longopen exceeding regr then the short term has priority and the long term focus is resumed if it is still longopen exceeded afterwards
