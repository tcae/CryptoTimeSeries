...
with_logger(logger) do
    ...
    # if a long term longbuy exceeding regr extreme is interrupted by a short term longbuy exceeding regr then the short term has priority and the long term focus is resumed if it is still longbuy exceeded afterwards
