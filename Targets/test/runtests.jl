...
@testset "Targets tests" begin
    ...
    with_logger(logger) do
        ...
        @test labels == ["longopen", "longopen", "longclose", "shortopen", "shortopen", "shortopen", "shortopen", "shortclose", "longopen", "longopen", "longopen", "longopen", "longclose", "shortopen", "shortopen", "shortopen", "shortclose", "longopen", "longopen", "longclose"]
        ...
        # not exceeding longopen thresholds should result always in next possible extreme => with graph search not the case
        ...
        # println("nearer extreme not exceeding longopen thresholds should not win against further away but longopen threshold exceeding extreme")
        ...
        f2 = Targets.fakef2fromarrays(ydata, [grad1, grad2])
        labels, relativedist, realdist, priceix = Targets.continuousdistancelabels(f2; labelthresholds=Targets.LabelThresholds(0.3, 0.05, -0.05, -0.3))
        # println("nearer extreme exceeding longopen thresholds should win against further away longopen threshold exceeding extreme")
        ...
        f2 = Targets.fakef2fromarrays(ydata, [grad1, grad2])
        labels, relativedist, realdist, priceix = Targets.continuousdistancelabels(f2; labelthresholds=Targets.LabelThresholds(0.3, 0.05, -0.05, -0.3))
        # println("if a long term longopen exceeding regr extreme is interrupted by a short term longopen exceeding regr then the short term has priority and the long term focus is resumed if it is still longopen exceeded afterwards")
