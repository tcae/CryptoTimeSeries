...
# if a long term longopen exceeding regr extreme is interrupted by a short term longopen exceeding regr then the short term has priority except the long term has mor than double gain
...
println("nearer extreme exceeding longopen thresholds should win against further away longopen threshold exceeding extreme if near-term longopen has at least 50% of the far-term longopen gain")
df = DataFrame()
df.ydata = ydata
df.grad1 = grad1
df.grad2 = grad2
