...
# not exceeding longopen thresholds should result always in next possible extreme
...
println("not exceeding longopen thresholds should result always in next possible extreme")
println(df)
