...
cfgnt = (regrwindow=1*24*60,trendthreshold=0.04f0, volatilitybuythreshold=-0.01f0, volatilitylongthreshold=0.0f0, volatilitysellthreshold=0.01f0, volatilityselltrendfactor=0f0)
