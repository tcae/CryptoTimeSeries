...
cfgnt = (regrwindow=1*24*60,longtrendthreshold=0.04f0, shortrendthreshold=-1f0, volatilitybuythreshold=-0.02f0, volatilitylongthreshold=0.0f0, volatilityshortthreshold=0.0f0, volatilitysellthreshold=0.02f0)
