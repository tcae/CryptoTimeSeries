...
"""
mk1config() = (configname="001", featconfig = f6config01(), targetconfig = targetconfig01(), classifiermodel=Classify.model001)
...
"""
mk2config() = (configname="002", featconfig = f6config01(), targetconfig = targetconfig01(), classifiermodel=Classify.model001)
...
"""
mk3config() = (configname="003", featconfig = f6config01(), targetconfig = targetconfig02(), classifiermodel=Classify.model001)

"""
mk4 = targetconfig03() with one merged set (allclose=>0.726, longbuy=>0.274)
"""
mk4config() = (configname="004", featconfig = f6config01(), targetconfig = targetconfig03(), classifiermodel=Classify.model001)

"""
mk5 = targetconfig04() with one merged set (allclose=>?, longbuy=>?)
"""
mk5config() = (configname="005", featconfig = f6config01(), targetconfig = targetconfig04(), classifiermodel=Classify.model001)
...
"""
mk6config() = (configname="006", featconfig = f6config01(), targetconfig = targetconfig01(), classifiermodel=Classify.model001)
...
"""
mk7config() = (configname="007", featconfig = f6config01(), targetconfig = targetconfig01(), classifiermodel=Classify.model001)
...
"""
mk9config() = (configname="009", featconfig = f6config01(), targetconfig = targetconfig01(), classifiermodel=Classify.model002)
...
"""
mk11config() = (configname="011", featconfig = f6config01(), targetconfig = targetconfig01(), classifiermodel=Classify.model003)

"""
mk12 = like mk9 but with an additional layer
"""
mk12config() = (configname="012", featconfig = f6config01(), targetconfig = targetconfig01(), classifiermodel=Classify.model004)

"""
mk13 = like mk9 but with 4/3 broader layers
"""
mk13config() = (configname="013", featconfig = f6config01(), targetconfig = targetconfig01(), classifiermodel=Classify.model005)

"""
mk14 = like mk11 but removed layer 3
"""
mk14config() = (configname="014", featconfig = f6config01(), targetconfig = targetconfig01(), classifiermodel=Classify.model006)

"""
mk15 = like mk11 but reduced number of nodes of layers by reducing factor of layer 1 from 3 to 2
"""
mk15config() = (configname="015", featconfig = f6config01(), targetconfig = targetconfig01(), classifiermodel=Classify.model007)
...
"""
mk16config() = (configname="016", featconfig = f6config01(), targetconfig = targetconfig05(), classifiermodel=Classify.model002)
...
"""
mk17config() = (configname="017", featconfig = f6config01(), targetconfig = targetconfig06(), classifiermodel=Classify.model002)

"""  
mk18 = mk9 but with simplified features
"""
mk18config() = (configname="018", featconfig = f6config03(), targetconfig = targetconfig01(), classifiermodel=Classify.model002)

"""  
mk19 = mk9 but with simplified features
"""
mk19config() = (configname="019", featconfig = f6config04(), targetconfig = targetconfig01(), classifiermodel=Classify.model002)

"""  
mk20 = mk17 but feature grads without offset
"""
mk20config() = (configname="020", featconfig = f6config05(), targetconfig = targetconfig06(), classifiermodel=Classify.model002)

"""  
mk21 = mk17 but feature grads without offset and 12h regr grad added
"""
mk21config() = (configname="021", featconfig = f6config06(), targetconfig = targetconfig06(), classifiermodel=Classify.model002)

"""  
mk22 = mk21 but with 3*24h regr grad added
"""
mk22config() = (configname="022", featconfig = f6config07(), targetconfig = targetconfig06(), classifiermodel=Classify.model002)
