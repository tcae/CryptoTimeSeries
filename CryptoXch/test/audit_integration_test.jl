...
@testset "CryptoXch audit integration" begin
    ...
    try
        ...
        push!(xc.closedorders, ack_order; cols=:subset)
        push!(xc.closedorders, filled_order; cols=:subset)
        push!(xc.closedorders, cancelled_order; cols=:subset)
        push!(xc.closedorders, signal_filled_order; cols=:subset)
